...
from common.valid_angle_check import h36m_valid_angle_check_torch
        ...
        with torch.no_grad():
            ...
            if not args.no_eval:
                ...
                for cam, batch, batch_2d in train_generator_eval.next_epoch():
                    ...
                    angles = h36m_valid_angle_check_torch(inputs_3d.reshape(-1, 17, 3))
                    for k, v in angles.items():
                        train_angles[k] = train_angles.get(k, []) + [v]
