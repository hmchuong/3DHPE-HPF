...
parser.add_argument('--batch_size',type=int,default=batch_size_mult*256,help= 'batch size')
parser.add_argument('--batch_size_test',type=int,default=3*batch_size_mult*256,help= 'batch size for the test set')
parser.add_argument('--lr',type=int,default=lr_mult*1e-02,help= 'Learning rate of the optimizer')
parser.add_argument('--use_scheduler',type=bool,default=True,help= 'use MultiStepLR scheduler')
parser.add_argument('--milestones',type=list,default=[15,25,35,40],#[10, 20, 35, 55, 80, 130, 170, 200, 230],
